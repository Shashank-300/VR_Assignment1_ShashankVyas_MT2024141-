...
def main():
    images = []
    image_paths = ['panroma1.jpeg', 'panroma2.jpeg', 'panroma3.jpeg']
    ...
    try:
        ...
        # Stitching Result with third image
        panorama_kp, panorama_desc = extract_keypoints(panorama)

        final_panorama = stitch_image_pair(
            panorama, images[2],
            panorama_kp, panorama_desc,
            keypoints_list[2], descriptors_list[2]
        )

        cv2.imwrite('stitched_result.jpg', final_panorama)
        print("Panorama saved as 'stitched_result.jpg'")

        visualize_panorama(final_panorama)
